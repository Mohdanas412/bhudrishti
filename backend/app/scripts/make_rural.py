...
with open("/app/uploads/rural/punjab_cadastral.geojson", "w") as f: json.dump(out_a, f)
with open("/app/uploads/rural/punjab_panchayat.geojson", "w") as f: json.dump(out_b, f)
